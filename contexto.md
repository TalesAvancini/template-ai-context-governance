...
---
schema_version: 1
generated_at: 2026-04-12T02:20:02.509419+00:00
...
FILE_START id=file_1edef35c2f56 path=.context/_scripts/harness_runner.py domain=source lang=python lines=98 bytes=4185 mtime=2026-04-12T02:19:13.274953+00:00 sha1=68fabe4491f4b946106164a492b0bf3eaa5194db
CHUNK_START id=1edef35c2f56_c001 start_line=1 end_line=98
```python
#!/usr/bin/env python3
"""
...
CHUNK_START id=e98b95e5fb6d_c001 start_line=1 end_line=61
```python
#!/usr/bin/env python3
"""
...
FILE_START id=file_019509328844 path=.context/maintenance/JOURNAL.md domain=docs lang=markdown lines=60 bytes=2068 mtime=2026-04-12T02:19:33.899789+00:00 sha1=633a92ca98c9dff79e56552d90e06c8d125d30d6
CHUNK_START id=019509328844_c001 start_line=1 end_line=60
```markdown
---
Criado em: 2026-04-10 20:50
...
FILE_START id=file_d069d4f2ebef path=.context/maintenance/TECHNICAL_REQUIREMENTS.md domain=docs lang=markdown lines=27 bytes=300 mtime=2026-04-12T02:19:33.454961+00:00 sha1=3e9d10cf3a85cdac8f4f33df6291f6a2f9547fe4
CHUNK_START id=d069d4f2ebef_c001 start_line=1 end_line=27
```markdown
---\nCriado em: 2026-04-10 20:50\nUltima Atualizacao: 2026-04-10 20:50\nStatus: Ativo\n---\n

<!-- AUTO-SYNC START -->
*🤖 Atualizado automaticamente em 2026-04-11 23:19*
...
FILE_START id=file_068a21d64bec path=.context/monitoring/CONTEXT_HEALTH.md domain=docs lang=markdown lines=37 bytes=1443 mtime=2026-04-12T02:19:34.321303+00:00 sha1=c3d2b66a73a1939d9ccfa0f2261fcb3b0720323e
CHUNK_START id=068a21d64bec_c001 start_line=1 end_line=37
```markdown
---
Criado em: 2026-04-10 20:50
Ultima Atualizacao: 2026-04-11 23:19
Status: Ativo
---
...
| :--- | :--- | :--- | :--- | :--- |
| **Manutencao** | | | | |
| Linhas do Journal | 60 | 600 | Tracker | [OK] |
| Carga do Journal | 2k chars | 50k chars | Tracker | [OK] |
| **Cognitivo** | | | | |
| Estimativa Tokens | ~16k | 128k (Max) | Eficiencia | [OK] |
| **Consistencia** | | | | |
| Tabelas no Schema | 1 | N/A | DB-First | [OK] |
| Ultimo Harness | Role Check | Pass/Fail | Integridade | [PASS] |
| Ultima Sincronia | 2026-04-11 23:19 | Real-Time | Automacao | [OK] |
<!-- HEALTH_TABLE_END -->
...
FILE_START id=file_3c39185314df path=.specs/features/hok-advanced-modules/STATE.md domain=docs lang=markdown lines=5 bytes=79 mtime=2026-04-12T02:19:33.901786+00:00 sha1=0da2f857bd752290181dec132e6df8a07a2ee200
CHUNK_START id=3c39185314df_c001 start_line=1 end_line=5
```markdown
---
status: ✅ PASSED
updated: 2026-04-11 23:19
detail: All checks passed
---

```
CHUNK_END id=3c39185314df_c001
...
CHUNK_START id=8746e653f22c_c001 start_line=1 end_line=24
```markdown
...
```
CHUNK_END id=8746e653f22c_c001
...
FILE_START id=file_aa78525fb574 path=contexto.md domain=docs lang=markdown lines=15991 bytes=649803 mtime=2026-04-12T00:58:07.423788+00:00 sha1=7629edef6464043998f7ed5218ffac734c0b2b8d
...
CHUNK_START id=aa78525fb574_c040 start_line=11701 end_line=12000
````markdown
            part += "\n"
        chunks.append(Chunk(f"{file_id}_c{idx:03d}", start + 1, end, part))
        idx += 1
...
CHUNK_START id=aa78525fb574_c041 start_line=12001 end_line=12300
````markdown
Projeto: [NOME DO PROJETO]
...
````
CHUNK_END id=aa78525fb574_c041
CHUNK_START id=aa78525fb574_c042 start_line=12301 end_line=12600
````markdown
...
````
CHUNK_END id=aa78525fb574_c042
CHUNK_START id=aa78525fb574_c043 start_line=12601 end_line=12900
````markdown
...
````
CHUNK_END id=aa78525fb574_c043
CHUNK_START id=aa78525fb574_c044 start_line=12901 end_line=13200
````markdown
Este plano detalha a transição do template de um sistema de documentação estática para um framework de governança ativa, focado em **escala**, **automação** e **prevenção de drift**.
...
````
CHUNK_END id=aa78525fb574_c044
CHUNK_START id=aa78525fb574_c045 start_line=13201 end_line=13500
````markdown
...
````
CHUNK_END id=aa78525fb574_c045
CHUNK_START id=aa78525fb574_c046 start_line=13501 end_line=13800
````markdown
...
````
CHUNK_END id=aa78525fb574_c046
CHUNK_START id=aa78525fb574_c047 start_line=13801 end_line=14100
````markdown
- **Conteúdo Robusto:** Tabela com Roles (`@db-architect`, `@frontend-specialist`, `@backend-engineer`, `@qa-validator`, `@devops-guardian`, `@context-keeper`, `@fullstack-generalist`), permissões granulares de escrita e gatilhos de ativação.
- **Human Insights:** Blocos de contexto explicando o "porquê" das decisões técnicas para futuras IAs.
...
````
CHUNK_END id=aa78525fb574_c047
CHUNK_START id=aa78525fb574_c048 start_line=14101 end_line=14400
````markdown
# 🛡️ Pre-flight Checks
check_deps() {
  command -v git >/dev/null 2>&1 || error "git e obrigatorio."
...
````
CHUNK_END id=aa78525fb574_c048
CHUNK_START id=aa78525fb574_c049 start_line=14401 end_line=14700
````markdown
...
````
CHUNK_END id=aa78525fb574_c049
CHUNK_START id=aa78525fb574_c050 start_line=14701 end_line=15000
````markdown
import unittest
import os
import shutil
...
````
CHUNK_END id=aa78525fb574_c050
CHUNK_START id=aa78525fb574_c051 start_line=15001 end_line=15300
````markdown
FILE_START id=file_450d7ec70909 path=.context/brain/TLC_INTEGRATION.md domain=docs lang=markdown lines=32 bytes=1739 mtime=2026-04-11T02:29:02.337886+00:00 sha1=35e6506fdaaa427e4d5795b83709f4f9da37fc2d
CONTENT_OMITTED toc_only=true
FILE_END id=file_450d7ec70909
...
````
CHUNK_END id=aa78525fb574_c051
CHUNK_START id=aa78525fb574_c052 start_line=15301 end_line=15600
````markdown
    while len(specs) > 3:
        shutil.move(str(specs.pop(0)), str(ARCHIVE_DIR))
    print("[OK] Manutencao de specs concluida.")
...
````
CHUNK_END id=aa78525fb574_c052
CHUNK_START id=aa78525fb574_c053 start_line=15601 end_line=15900
````markdown
FILE_END id=file_32db3e3783df
...
````
CHUNK_END id=aa78525fb574_c053
CHUNK_START id=aa78525fb574_c054 start_line=15901 end_line=15991
````markdown
import shutil
import tempfile
import subprocess
...
````
CHUNK_END id=aa78525fb574_c054
FILE_END id=file_aa78525fb574
...
CHUNK_START id=350a79f8b829_c001 start_line=1 end_line=70
```python
#!/usr/bin/env python3
"""
🐍 run_context.py - Gestor Universal de Contexto (v2.2.1 Premium)
